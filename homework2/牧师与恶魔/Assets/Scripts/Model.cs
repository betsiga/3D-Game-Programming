...
public class Model : MonoBehaviour
{
    ...
    {
        //bank  
        Instantiate(Resources.Load("Prefabs/Shore"), bankStartPos, Quaternion.identity);
        Instantiate(Resources.Load("Prefabs/Shore"), bankEndPos, Quaternion.identity);

        //ship  
        ship_obj = Instantiate(Resources.Load("Prefabs/Boat"), shipStartPos, Quaternion.identity) as GameObject;
